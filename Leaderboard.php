...
<body>
    ...
    <div class="text-2xl">Welcome to the Leaderboard page! Unfortunately this page is currently under development therefore you cannot see anything.</div>
        <div class="text-4xl mt-3 flex items-center font-medium">
            ...
            <a href="home.php" class="text-sm mt-5">Back to home</a>
    </div>
